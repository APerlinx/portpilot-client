...
const Footer = () => {
  return (
    <footer className="border-t border-gray-200 bg-third mt-24">
      <div className="mx-auto max-w-7xl px-6 py-12">
        <div className="grid gap-8 md:grid-cols-2">
          {/* Brand */}
          <div className="text-center md:text-left">
            <h2 className="text-xl font-bold text-gray-300 flex items-center justify-center md:justify-start">
              <img src={logo} alt="PortPilot Logo" className="h-12" /> Port
              <span className="text-fourth">Pilot</span>
            </h2>
        ...
        {/* Bottom note */}
        <div className="mt-12 border-t border-primary pt-6 text-center text-sm text-gray-300">
